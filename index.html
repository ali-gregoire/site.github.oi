...
<body>
  ...
  <div id="carouselExampleCaptions" class="carousel slide">
    <div class="carousel-inner">
      <div class="carousel-item active" style="background-image: url('securite.jpg');">
      ...
      <div class="carousel-item" style="background-image: url('savon.jpg');">
        <div class="carousel-caption d-block text-center">
          <h1>ESSO-PLUS</h1>
      ...
      <div class="carousel-item" style="background-image: url('entretien.jpg');">
        <div class="carousel-caption d-block text-center">
          <h1>ESSO-PLUS</h1>
      ...
      <div class="carousel-item" style="background-image: url('transport.jpg');">
        <div class="carousel-caption d-block text-center">
          <h1>ESSO-PLUS</h1>
      ...
      <div class="carousel-item" style="background-image: url('jardin.jpg');">
        <div class="carousel-caption d-block text-center">
          <h1>ESSO-PLUS</h1>
          <p>Jardinage de Votre milieu </p>
          <a href="jardinnage.php" class="btn btn-primary">En savoir plus</a>
        </div>
      </div>
    </div>
...
.xbox {
  height: 350px;
  margin-bottom: 20px;
  background: url(formation.jpg) no-repeat center center/cover;
}
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="jardinnage.php" class="btn btn-primary btn-en-savoir-plus">En savoir plus</a>
      </div>
      <div class="col-sm-6">
        <div class="img">
